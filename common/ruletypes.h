...
RULE_INT(World, PVPLevelWeightMultiplier, 2, "PVP Point System Level Weight Multiplier")
RULE_INT(World, PVPInfamyCap, 8, "PVP Point System Infamy Cap")
RULE_INT(World, PVPKillCountDays, 1, "PVP Point System Kill Count Days. Prevent attacker from obtaining PVP points from the same victim within the number of days.")
RULE_INT(World, PVPKillCountDaysLimit, 1, "PVP Point System Kill Count Days. Prevent attacker from obtaining PVP points from the same victim within the number of days.")
RULE_INT(World, PVPPointsCap, 32, "PVP Point System Cap Per Player.")
