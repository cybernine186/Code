...
namespace DatabaseSchema {
	...
	static std::map<std::string, std::string> GetCharacterTables()
	{
		return {
			...
			{"completed_shared_task_members",  "character_id"},
			...
			{"raid_members",                   "charid"},
			{"shared_task_members",            "character_id"},
			{"timers",                         "char_id"},
			{"titles",                         "char_id"},
			{"trader",                         "char_id"},
			{"zone_flags",                     "charID"}
